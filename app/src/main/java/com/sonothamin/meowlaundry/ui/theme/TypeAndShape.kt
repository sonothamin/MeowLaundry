...
// Roboto Flex is the correct MD3 default typeface (not something to avoid here).
...
// MD3 Expressive corner tokens: fuller, friendlier rounding than classic MD3.
...
/** 8dp spacing scale, per the Expressive layout guidance. */
object Spacing {
    val xs = 4.dp
    val sm = 8.dp
    val md = 16.dp
